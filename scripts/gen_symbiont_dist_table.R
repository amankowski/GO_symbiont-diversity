...
symbiont.tree.individuals<-read.tree("./data/symbiont-tree.individuals.newick")
symbiont.labels<-grep(symbiont, symbiont.tree.individuals$tip.label, value=T)
symbiont.remove<-setdiff(symbiont.tree.individuals$tip.label, symbiont.labels)
symbiont.tree<-drop.tip(symbiont.tree.individuals, symbiont.remove)
